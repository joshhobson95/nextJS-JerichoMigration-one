...
const Bios = () => {
  ...
  const toggleExpand = (setter, state) => {
    setter(!state);
  };
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedKiana, isExpandedKiana)}>
      {isExpandedKiana ? '-' : '+'}
    </button>
    <h2>Kiana</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedScott, isExpandedScott)}>
      {isExpandedScott ? '-' : '+'}
    </button>
    <h2>Scott</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedChantelle, isExpandedChantelle)}>
      {isExpandedChantelle ? '-' : '+'}
    </button>
    <h2>Chantelle</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedKelly, isExpandedKelly)}>
      {isExpandedKelly ? '-' : '+'}
    </button>
    <h2>Kelly</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedDolly, isExpandedDolly)}>
      {isExpandedDolly ? '-' : '+'}
    </button>
    <h2>Dolly</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedIsaac, isExpandedIsaac)}>
      {isExpandedIsaac ? '-' : '+'}
    </button>
    <h2>Isaac</h2>
  </div>
...
<div className={styles.bio_single}>
  <div className={styles.bio_header}>
    <button onClick={() => toggleExpand(setIsExpandedKendra, isExpandedKendra)}>
      {isExpandedKendra ? '-' : '+'}
    </button>
    <h2>Kendra</h2>
  </div>
